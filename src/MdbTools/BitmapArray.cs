...
// Updated from .net BitArray to allow using a ReadOnlySpan as input to avoid an
// extra allocation
...
namespace MMKiwi.Collection
{
    // A vector of bits.  Use this to store bits efficiently, without having to do bit
    // shifting yourself.
    [Serializable]
    [TypeForwardedFrom("mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089")]
    public sealed class BitmapArray : IEnumerable<bool>, ICloneable, IReadOnlyList<bool>
    {
        ...
        ** Exceptions: ArgumentOutOfRangeException if length < 0.
        =========================================================================*/
        public BitmapArray(int length, bool defaultValue)
        {
            if (length < 0)
            {
        ...
        public BitmapArray(ReadOnlySpan<byte> bytes)
        {
            ...
            {
                throw new ArgumentException($"The input array length must not exceed Int32.MaxValue / {BitsPerByte}. Otherwise BitArray.Length would exceed Int32.MaxValue.", nameof(bytes));
            }
        ...
        ** Exceptions: ArgumentException if bytes == null.
        ...
        public unsafe BitmapArray(bool[] values)
        {
        ...
        ** Exceptions: ArgumentException if values == null.
        ...
        public BitmapArray(int[] values)
        {
            ...
            {
                throw new ArgumentException($"The input array length must not exceed Int32.MaxValue / {BitsPerInt32}. Otherwise BitArray.Length would exceed Int32.MaxValue.", nameof(values));
            }
        ...
        ** Exceptions: ArgumentException if values == null.
        =========================================================================*/
        public BitmapArray(ReadOnlySpan<int> values)
        {
        ...
        ** Exceptions: ArgumentException if bits == null.
        =========================================================================*/
        public BitmapArray(BitmapArray bits)
        {
        ...
        **             value.Length != this.Length.
        =========================================================================*/
        public unsafe BitmapArray And(BitmapArray value)
        {
        ...
        **             value.Length != this.Length.
        =========================================================================*/
        public unsafe BitmapArray Or(BitmapArray value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        **             value.Length != this.Length.
        =========================================================================*/
        public unsafe BitmapArray Xor(BitmapArray value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        ** Exceptions: ArgumentOutOfRangeException if count < 0
        =========================================================================*/
        public BitmapArray RightShift(int count)
        {
            if (count <= 0)
            {
                if (count < 0)
        ...
        ** Exceptions: ArgumentOutOfRangeException if count < 0
        =========================================================================*/
        public BitmapArray LeftShift(int count)
        {
            if (count <= 0)
            {
                if (count < 0)
        ...
        public unsafe void CopyTo(Array array, int index)
        {
            ...
            {
                throw new ArgumentException("Only supported array types for CopyTo on BitArrays are Boolean[], Int32[] and Byte[].", nameof(array));
            }
        }
        ...
        public object Clone() => new BitmapArray(this);
        ...
        {
            private readonly BitmapArray _bitArray;
            private int _index;
            private readonly int _version;
            private bool _currentElement;

            internal BitArrayEnumeratorSimple(BitmapArray bitArray)
            {
                _bitArray = bitArray;
                _index = -1;
