...
/// </summary>
/// <remarks>
/// Ensure that the <see cref="MdbHandle" /> that the field value was originally 
...
public class MdbLValStream : Stream
{
    ...
    /// <throws cref="ObjectDisposedException">Methods were called after the <see cref="MdbHandle" /> was closed.</throws>
